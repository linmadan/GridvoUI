...
var ConfigDashBoard = React.createClass({
    ...
    loadRDConfigPanel: function (event) {
        var RDConfigPanel = require('./rDConfigPanel.js');
        ReactDOM.render(
            <RDConfigPanel stationName={this.props.stationName}/>,
            document.getElementById('config_content')
        );
    },
        ...
        return (
            <div className="weui_tab">
                ...
                <div className="weui_tabbar">
                    <a href="javascript:;" onClick={this.loadRDConfigPanel}
